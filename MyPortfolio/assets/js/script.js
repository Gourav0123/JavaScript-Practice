...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 3. Scroll Reveal Animations (Intersection Observer)
    // Fade in elements when they become visible in viewport
    const fadeElements = document.querySelectorAll('.service-card, .portfolio-item, .contact-form-wrapper, .bg-gradient-box + img');
    ...
    // 5. Statistics Counter Animation
    const statElements = document.querySelectorAll('.display-5.fw-bold.text-gradient-primary');
    ...
    // 6. Smooth Scrolling for Navigation Links & Buttons
        ...
        anchor.addEventListener('click', function (e) {
            ...
            if (targetElement) {
                ...
                if (navbarCollapse && navbarCollapse.classList.contains('show')) {
                    // Using Bootstrap 5 collapse API to hide it
